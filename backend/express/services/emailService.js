...
class EmailService {
  static async sendVerificationOTP(email, otp, fullName) {
    ...
    const mailOptions = {
      from: `"MindZen" <${process.env.EMAIL_USER}>`,
      to: email,
      subject: 'MindZen – Email Verification',
      html: `
        <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background: #f9fafb;">
          <div style="background: #ffffff; border-radius: 12px; padding: 32px; box-shadow: 0 6px 20px rgba(0,0,0,0.08);">
            ...
            <div style="text-align: center; margin-bottom: 30px;">
              <h1 style="color: #4F46E5; margin: 0; font-size: 28px; font-weight: 700;">MindZen</h1>
            ...
            <p style="color: #374151; line-height: 1.6; font-size: 15px; margin-bottom: 24px;">
              Thank you for joining MindZen! Please verify your email address to activate your account and start exploring your study insights.
            </p>
            ...
            <div style="background: #FEF3C7; border-left: 4px solid #F59E0B; padding: 14px 18px; margin-top: 24px; border-radius: 0 8px 8px 0;">
              <p style="margin: 0; color: #92400E; font-size: 13px;">
                <strong>Security Note:</strong> If you didn’t create an MindZen account, please ignore this email.
              </p>
            </div>

            <div style="text-align: center; margin-top: 32px; padding-top: 20px; border-top: 1px solid #E5E7EB;">
              <p style="color: #6B7280; font-size: 13px; margin: 0;">
                © ${new Date().getFullYear()} MindZen. All rights reserved.<br>
  ...
  static async sendPasswordResetOTP(email, otp, fullName) {
    const mailOptions = {
      from: `"MindZen" <${process.env.EMAIL_USER}>`,
      to: email,
      subject: 'MindZen – Password Reset Request',
      html: `
        <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background: #f9fafb;">
          <div style="background: #ffffff; border-radius: 12px; padding: 32px; box-shadow: 0 6px 20px rgba(0,0,0,0.08);">
            ...
            <p style="color: #374151; line-height: 1.6; font-size: 15px; margin-bottom: 24px;">
              We received a request to reset your MindZen account password. Use the code below to continue the process.
            </p>
