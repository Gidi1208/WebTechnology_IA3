...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/verify-email', { state: { email: formData.email, fullName: formData.fullName } });
    } catch (error) {
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="rounded-lg p-8 shadow-lg" style={{
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="fullName" className="block text-sm font-medium mb-2 select-none" style={{ color: 'var(--color-text-primary)' }}>
                Full Name
              </label>
              <input
                id="fullName"
                ...
                style={{
                  ...
                  borderColor: errors.fullName ? 'var(--color-button-danger)' : 'var(--color-input-border)',
            ...
            <div>
              <label htmlFor="username" className="block text-sm font-medium mb-2 select-none" style={{ color: 'var(--color-text-primary)' }}>
                Username
              </label>
              <input
                id="username"
                ...
                style={{
                  backgroundColor: 'var(--color-input-background)',
                  borderColor: errors.username ? 'var(--color-button-danger)' : 'var(--color-input-border)',
                  color: 'var(--color-text-primary)',
                  focusRingColor: 'var(--color-input-focus)'
                }}
            ...
            <div>
              <label htmlFor="email" className="block text-sm font-medium mb-2 select-none" style={{ color: 'var(--color-text-primary)' }}>
                Email Address
              </label>
              <input
                id="email"
                ...
                style={{
                  backgroundColor: 'var(--color-input-background)',
                  borderColor: errors.email ? 'var(--color-button-danger)' : 'var(--color-input-border)',
                  color: 'var(--color-text-primary)',
                  focusRingColor: 'var(--color-input-focus)'
                }}
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium mb-2 select-none" style={{ color: 'var(--color-text-primary)' }}>
                Password
              </label>
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium mb-2 select-none" style={{ color: 'var(--color-text-primary)' }}>
                Confirm Password
              </label>
              <div className="relative">
                <input
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="agreeToTerms" className="ml-2 block text-sm select-none" style={{ color: 'var(--color-text-primary)' }}>
                I agree to the{' '}
                <a href="#" className="hover:underline" style={{ color: 'var(--color-link)' }}>
